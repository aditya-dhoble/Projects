 ...
 * TODONE: Save the guess history in a variable called guess
 * TODONE: Display the guess history using displayHistory() function
 * TODONE: Use the initGame() function to restart the game
 */
